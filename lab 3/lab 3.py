...
class PaperBook(Book):
    ...
    def __str__(self):
        return f"Бумажная книга:Автор {self.author}. Название {self.name}. Количество страниц {self.pages}"
    ...
    def pages(self, new_pages: int) -> None:
        if not isinstance(new_pages, int):
            ...
            raise ValueError('Количество станиц не может быть отрицательным.')
...
class AudioBook(Book):
    ...
    def __str__(self):
        return f"Электронная книга: Автор {self.author}. Название {self.name}.  Продолжительность {self.duration} сек"